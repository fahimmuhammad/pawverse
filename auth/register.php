...
<body class="bg-[color:var(--deep-1)] text-[color:var(--text)] h-screen flex flex-col antialiased">
  ...
  <main class="flex-1 flex items-center justify-center px-6">
    <div class="w-full max-w-md card-glass rounded-3xl p-8 fade-up">
      ...
      <p class="opacity-70 text-center text-sm mb-6">Join PawVerse to shop and book vet services</p>

      <form id="registerForm" class="space-y-4">
        <div>
          <label class="text-sm opacity-80 mb-1 block">Full Name</label>
        ...
        <div>
          <label class="text-sm opacity-80 mb-1 block">Confirm Password</label>
